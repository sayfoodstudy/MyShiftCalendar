...
public class MainActivity extends Activity {
    ...
    private void showAddBasicAlarmDialog() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            timePicker.setHour(defaultTime.getHour());
            timePicker.setMinute(defaultTime.getMinute());
        } else {
            timePicker.setCurrentHour(defaultTime.getHour());
            timePicker.setCurrentMinute(defaultTime.getMinute());
        }
    ...
    private int getTimePickerHour(TimePicker timePicker) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) return timePicker.getHour();
        return timePicker.getCurrentHour();
    }

    private int getTimePickerMinute(TimePicker timePicker) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) return timePicker.getMinute();
