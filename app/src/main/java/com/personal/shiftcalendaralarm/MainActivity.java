...
public class MainActivity extends Activity {
    ...
    private void showAlarmListForFolder(final long folderId, final String titleText, final boolean canDeleteFolder) {
        ...
        if (folderId < 0) {
            ...
            addFolder.setText("폴더 만들기");
            root.addView(addFolder, matchWrap());
            addFolder.setOnClickListener(v -> showAddAlarmFolderDialog(refresh));
        ...
        if (folderId < 0 && !alarms.isEmpty()) {
            TextView section = new TextView(this);
            section.setText("폴더 없음");
            section.setTextSize(15);
            section.setTypeface(Typeface.DEFAULT_BOLD);
            section.setPadding(0, dp(8), 0, dp(2));
